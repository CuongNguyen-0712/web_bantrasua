...
<html lang="en">
<head>
    <link rel="stylesheet" href="/web_bantrasua/myapp/public/assets/styles/user/thongtincanhan copy.css">
    <meta charset="UTF-8">
                    ...
                    <div class="Information__group">
                        ...
                        <form action="index.php?url=user/save" method="POST" class="form">
                            <div class="form__info">
                                ...
                                <input class="form__input" name="phone" type="text" id="number" placeholder="0345621117"
                            ...
                            <div class="form__info">
                                <label class="form__label" for="city">Tỉnh/Thành Phố</label>
                            ...
                            <div class="form__info">
                                ...
                                <input class="form__input" name="ward" type="text" id="ward"
                                    value="<?= htmlspecialchars($old['ward'] ?? '') ?>">
                            </div>
