                        ...
                        <header class="purchase-header">
                            <div class="purchase-header__heading">
                                ...
                                <button class="purchase-header__heading-btn-shop">
                                    ...
                                    <a href="/web_bantrasua/myapp/user/home/index" class="purchase-header__heading-btn-content">Trang chủ </a>
                                </button>
                            </div>
                        ...
                        <?php foreach($order['productInfo'] as $productInfo): ?>
                            <div class="order-form__item">
                                ...
                                <div class="order-form__item-image">
                                    <img src="/web_bantrasua/myapp/public/assets/img<?php echo $productInfo['img'] ?>" alt="<?php echo $productInfo['name'] ?>" class="order-form__item-img">
                                </div>
                                ...
                                <div class="order-form__cost"><?php echo number_format($productInfo['productTotal'], 0, ',', '.') . "₫"?></div>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <footer class="order-form__footer">
                            ...
                            <div class="order-form__btn">
                                ...
                                <button class="order-form__btn-more">
                                    <a href="/web_bantrasua/myapp/user/process/show/<?php echo $order['order_id'] ?>" style="text-decoration: none; color: black">Thêm</a></button>
                            </div>
                        </footer>
                    </div>
                <?php endforeach; ?>
