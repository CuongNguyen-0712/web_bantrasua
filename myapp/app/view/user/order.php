                    ...
                    button.addEventListener('click', function() {
                        ...
                        selectedSweet = {
                            ...
                            levelId: this.hasAttribute('data-level-id') ? parseInt(this.getAttribute('data-level-id')) : 
                                     (this.getAttribute('data-sweet') === 'Ít' ? 7 : 
                ...
                iceButtons.forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        selectedIce = {
                            ...
                            levelId: this.hasAttribute('data-level-id') ? parseInt(this.getAttribute('data-level-id')) : 
                                    (this.getAttribute('data-ice') === 'Ít' ? 4 : 
                ...
                if (sweetButtons.length > 0 && !document.querySelector('.sweet-btn.selected')) {
                    ...
                    if (defaultSweetBtn) {
                        ...
                        selectedSweet = {
                            ...
                            levelId: defaultSweetBtn.hasAttribute('data-level-id') ? parseInt(defaultSweetBtn.getAttribute('data-level-id')) : 8
                        };
                    }
                }
                ...
                if (iceButtons.length > 0 && !document.querySelector('.ice-btn.selected')) {
                    ...
                    if (defaultIceBtn) {
                        ...
                        selectedIce = {
                            ...
                            levelId: defaultIceBtn.hasAttribute('data-level-id') ? parseInt(defaultIceBtn.getAttribute('data-level-id')) : 5
                        };
                    }
                }
