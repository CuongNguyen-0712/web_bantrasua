                    ...
                    <div class="Information__group">
                        ...
                        <form action="/web_bantrasua/myapp/user/user/save" method="POST" class="form">
                            <div class="form__info">
                                ...
                                <input class="form__input" name="username" type="text" id="username"
                                    placeholder="Hoàng Mạnh Hà" value="<?= htmlspecialchars($old['username'] ?? '') ?>">

                                <label class="form__label" for="number">Số Điện Thoại</label>
                                <input class="form__input" name="phone_number" type="text" id="number"
                                    placeholder="0345621117"
                            ...
                            <div class="form__info">
                                ...
                                <input class="form__input" name="email" type="email" id="email"
                                    placeholder="hmha@sgu.edu.vn" value="<?= htmlspecialchars($old['email'] ?? '') ?>">
