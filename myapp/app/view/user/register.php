                ...
                <form action="/web_bantrasua/myapp/user/user/register" method="post" class="auth-form">
                    <div class="auth-form__header">
                        <div class="auth-form__welcome">
                            <span class="auth-form-heading">Welcome to
                                <a href="/web_bantrasua/myapp/user/home/index"
                                    style="text-decoration: none; color: rgb(2, 108,61)">
                        ...
                        <span class="auth-form__switch-btn">Bạn đã có tài khoản?
                            <a href="/web_bantrasua/myapp/user/auth/login" class="auth-form__switch-btn-link">Đăng
                                nhập</a>
                        </span>
                    </div>
                    ...
                    <div class="auth-form__form">
                        <div class="auth-form__group">
                            ...
                            <input type="text" name="username" class="auth-form__input" placeholder="Nhập họ tên"
                                required>
                        </div>
                        <div class="auth-form__group">
                            <span class="auth-form__title">Nhập email:</span>
                            <input type="email" name="email" class="auth-form__input" placeholder="Nhập email"
                                required>
                        </div>
                        <div class="auth-form_w_group">
                        ...
                        <div class="auth-form__group">
                            ...
                            <input type="password" name="confirm_password" class="auth-form__input"
