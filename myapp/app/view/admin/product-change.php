...
<body>
    ...
    <div class="content">
        <form action="/web_bantrasua/myapp/admin/product/update/<?= $product['id'] ?>" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label for="productName">Tên sản phẩm</label>
                <input type="text" name="name" id="productName" value="<?= htmlspecialchars($product['name']) ?>" required />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php foreach ($sizes as $size):
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <input type="number" name="prices[<?= $size['id'] ?>]" value="<?= htmlspecialchars($priceSize) ?>" required />
                    </div>
                <?php endforeach; ?>
            </div>
